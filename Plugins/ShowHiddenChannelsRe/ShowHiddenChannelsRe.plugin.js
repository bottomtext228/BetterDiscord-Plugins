			...
			render() {
				...
				return BDFDB.ReactUtils.createElement(BDFDB.LibraryComponents.ListRow, {
					prefix: BDFDB.ReactUtils.createElement("div", {
						...
						children: BDFDB.ReactUtils.createElement("div", {
							style: {
								...
								height: "100%",
								width: "100%",
								backgroundColor: BDFDB.ColorUtils.convert(this.props.role.colorString ? this.props.role.colorString : "#f2f3f5", "RGB") || BDFDB.DiscordConstants.Colors.PRIMARY_DARK_300
							}
						})
					}),
					...
					label: BDFDB.ReactUtils.createElement("span", {
						...
						style: { color: this.props.role.colorString ? this.props.role.colorString : "#f2f3f5" }
					})
				});
			}
		};
...
/* 						"ChannelItem" */
			...
			onChannelContextMenu(e) {
				if (e.instance.props.channel && e.instance.props.channel.guild_id) {
					...
					if (isHidden || this.settings.general.showForNormal) {
						if (e.returnvalue.props.children.length) e.returnvalue.props.children.push(BDFDB.ContextMenuUtils.createItem(BDFDB.LibraryComponents.MenuItems.MenuSeparator, {}));
			...
			processChannelsList(e) {
				...
				let processCategory = (category, insertChannelless) => {
					...
					if (channelArray.length) {	// here we get hidden channels
